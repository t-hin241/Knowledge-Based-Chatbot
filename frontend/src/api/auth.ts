...
export interface UserResponse { id: number; email: string; username: string; is_active: boolean; created_at: string; avatar_url?: string; plan: string }
export const authApi = {
  ...
  updateMe: (data: { email?: string; username?: string; current_password?: string; new_password?: string; plan?: string }) =>
